...
EvoAPI::EvoAPI() :
    ...
    solver{ LDLTSolver() },
    titan{ EvoIndividual() },
    titan_robust_dataset{ EvoRegression::EvoDataSet() },
    titan_nonrobust_dataset{ EvoRegression::EvoDataSet() },
 ...
 */
EvoRegression::EvoDataSet EvoAPI::get_dataset() {
    return EvoRegression::EvoDataSet{ x, y };
}
